...
(function ($, undefined) {
    ...
    me.DefaultLoadingScreen = me.ScreenObject.extend({
        ...
        init: function () {
            ...
            this.logo2 = new me.Font('century gothic', 32, '#7C8998', 'middle');
            this.logo2.bold();
        ...
        draw: function (context) {
            ...
            // measure the logo size
            var logo1_width = this.logo1.measureText(context, "Ragnarok").width;
            var xpos = (context.canvas.width - logo1_width - this.logo2.measureText(context, " ...loading").width) / 2;
